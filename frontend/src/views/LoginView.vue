  ...
  <div class="min-h-screen bg-gray-900 flex items-center justify-center px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
        ...
        <div v-if="showNotImplementedMessage" class="bg-yellow-900 border border-yellow-700 rounded-lg p-4 mb-4">
          <div class="flex items-center">
            ...
            <button
              type="button"
              @click="showNotImplementedMessage = false"
...
const showNotImplementedMessage = ref(false)
...
const handleOAuthClick = () => {
  showNotImplementedMessage.value = true
}
